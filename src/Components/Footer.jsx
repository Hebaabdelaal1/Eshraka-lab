  ...
  <div className="container mx-auto px-6 md:px-12 grid md:grid-cols-3 gap-6 text-center md:text-right items-start">
    <div>
      ...
      <ul className="space-y-2">
        <li><a href="#home" className="hover:text-sky-200 transition"> الرئيسية</a></li>
        <li><a href="#about" className="hover:text-sky-200 transition"> من نحن</a></li>
        <li><a href="#services" className="hover:text-sky-200 transition">خدماتنا</a></li>
        <li><a href="#contact" className="hover:text-sky-200 transition">تواصل معنا</a></li>
      </ul>
    </div>
